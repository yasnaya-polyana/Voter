...
export default function DashboardPage() {
    ...
    async function loadCampaigns() {
      if (wallet && isSignedIn) {
        try {
          ...
          const userCampaigns = await contract.get_user_campaigns({
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {loading ? (
        <div className="text-center">Loading your campaigns...</div>
      ) : campaigns.length > 0 ? (
            ...
            <div key={campaign.id} className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <div className="card-actions justify-end">
                  <Link href={`/campaign/${campaign.id}`} className="btn btn-primary">
                    View Details
                  </Link>
                </div>
              </div>
